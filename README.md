## ⚠️ Version 2 available: [Neural-Romance-v2](https://github.com/colinrizzman/Neural-Romance-v2)
...
- Trained models [trained_models.tar.xz](https://github.com/colinrizzman/Neural-Romance/releases/download/trained_models/trained_models.tar.xz)
